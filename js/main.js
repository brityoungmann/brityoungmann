...
(function($) {
   ...
   ------------------------------------------------------ */
  	...
  	$('.js #teaching').waypoint(function() {
   	$('.js #teaching input[type="email"]').addClass( 'animated fadeInLeftBig show' );
    	$('.js #teaching input[type="submit"]').addClass( 'animated fadeInRightBig show' );
  	}, { offset: 'bottom-in-view' });
